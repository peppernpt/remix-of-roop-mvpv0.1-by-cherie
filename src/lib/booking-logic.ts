...
// All 77 Thai provinces. Bangkok and its neighbours lead the list (most
// customers), the rest are alphabetical. Values must stay stable — they are
// stored on bookings and matched by the availability buffer logic.
